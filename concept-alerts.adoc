...
The BlueXP alerts service helps you stay informed about risks or potential risk in your ONTAP storage environment. You can view alerts related to the following aspects: 
...
* Evaluates your alerts posture and displays it in an easy-to-understand dashboard.
...
* Applies curated recovery to meet RPO policies. BlueXP alerts orchestrates recovery from ransomware incidents by using several NetApp recovery services, including BlueXP backup and recovery (formerly Cloud Backup) and SnapCenter. 
