...
BlueXP alerts assesses the protection on your workloads and recommends actions to improve that protection. 
...
| Add a alerts policy. | The workload is currently not protected.  | Assign a policy to the workload. 
...
. From the BlueXP left navigation, select *Protection* > *alerts*. 
...
* From the BlueXP alerts menu, select *Reports*. 
...
You can access the technical documentation from docs.netapp.com or from inside the BlueXP alerts service. 
...
. Select *What's new* to view details in the Release Notes or *Documentation* to view the BlueXP alerts documentation Home page.  